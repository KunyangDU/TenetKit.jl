function addIntr!(Root::AbstractTreeNode,
    ...
    addIntr1!(Root,A,site,name,strength,Z)
end
...
function addIntr!(Root::AbstractTreeNode,
    ...
    Z::Union{Nothing,AbstractTensorMap})
    strength ≈ 0 && return nothing
    addIntr1!(Root,A[1],site[1],name[1],strength,Z)
end
...
function addIntr!(Root::AbstractTreeNode,
    ...
    Z::Union{Nothing,AbstractTensorMap})
    strength ≈ 0 && return nothing
    addIntr2!(Root,A,site,name,strength,Z)
end
...
function addIntr!(Tree::InteractionTree,
    ...
    Z::Union{Nothing,AbstractTensorMap})
    strength ≈ 0 && return nothing
    addIntr1!(Tree.Root.children[1],A,site,name,strength,Z)
end
...
function addIntr!(Tree::InteractionTree,
    ...
    Z::Union{Nothing,AbstractTensorMap})
    strength ≈ 0 && return nothing
    addIntr1!(Tree.Root.children[1],A[1],site[1],name[1],strength,Z)
end
...
function addIntr!(Tree::InteractionTree,
    ...
    Z::Union{Nothing,AbstractTensorMap})
    strength ≈ 0 && return nothing
    addIntr2!(Tree.Root.children[1],A,site,name,strength,Z)
end
