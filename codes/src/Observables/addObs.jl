...
function addObs!(Obsf::ObserableForest,
    Opri::Union{AbstractTensorMap,NTuple{2,AbstractTensorMap}},
    site::Union{Int64,NTuple{2,Int64}},
    name::Union{String,NTuple{2,String}},
    Z::Union{Nothing,AbstractTensorMap};ObsName = nothing
    ...
    if ObsName ∉ keys(Obsf.Roots)
        Obsf.Roots[ObsName] = ObservableTreeNode(IdentityOperator())
        Obsf.width += 1
    end
    
    addIntr!(Obsf.Roots[ObsName], Opri, site, name,1,Z)
end

# function _addBranch!(Obs::ObserableTree,name::String)
#     addchild!(Obs.Root,ObservableTreeNode(IdentityOperator(0,name)))
# end

# function _addBranch!(Obsf::ObserableForest,name::Union{String,Tuple})
#     addchild!(Obsf.Roots,ObservableTreeNode(IdentityOperator(0,name)))
# end
