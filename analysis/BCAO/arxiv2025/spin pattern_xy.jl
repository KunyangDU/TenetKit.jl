...
params23 = (J2 = -0.038, J3xy = 0.31, J3z = 0.0092, Hx = 0.16)
paramsh = (pinh=0.,)
...
Sm = maximum(sqrt.((Sx.^2 + Sy.^2 + Sz.^2))[4Ly+1:size(Latt)-4Ly-1])/2
...
display(fig)
save("$(figurename)/spin pattern_$(Lx)x$(Ly)_$(D)_$(params_Kitaev)_$(tailname).png",fig)
save("$(figurename)/spin pattern_$(Lx)x$(Ly)_$(D)_$(params_Kitaev)_$(tailname).pdf",fig)
# end
