...
lsHf = 0:0.02:0.8
lsk = map(x -> coordinate(x;basis = KBASIS2),[[1,0],[0,1],[1,1],-[1,0],-[0,1],-[1,1]])
lsΓ = 0:0.05:0.3
# lsΓ = 0:0.04:0.2
...
save("$(figurename)/stack_SSF_$(Lx)x$(Ly)_$(D)_$(θ/pi)_$(ϕ/pi)_$(K)_Gamma2.png",fig)
save("$(figurename)/stack_SSF_$(Lx)x$(Ly)_$(D)_$(θ/pi)_$(ϕ/pi)_$(K)_Gamma2.pdf",fig)
# end
