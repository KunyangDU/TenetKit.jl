...
lsk = map(x -> coordinate(x/3;basis = KBASIS2),[[1,2],[2,1],[1,-1],[-1,1],-[1,2],-[2,1]])
# lsΓ = vcat(0:0.02:0.08,0.12:0.04:0.2)
# lsΓ = 0:0.02:0.1
...
save("$(figurename)/stack_SSF_$(Lx)x$(Ly)_$(D)_$(θ/pi)_$(ϕ/pi)_K_$(K).png",fig)
save("$(figurename)/stack_SSF_$(Lx)x$(Ly)_$(D)_$(θ/pi)_$(ϕ/pi)_K_$(K).pdf",fig)
# end
