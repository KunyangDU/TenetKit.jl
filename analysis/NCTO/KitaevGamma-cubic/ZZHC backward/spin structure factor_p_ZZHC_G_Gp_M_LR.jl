...
lsk = map(x -> coordinate(x/4;basis = KBASIS2),[[1,1],-[1,1]])
...
save("$(figurename)/M_LR_$(Lx)x$(Ly)_$(D)_$(params1_Kitaev).png",fig)
save("$(figurename)/M_LR_$(Lx)x$(Ly)_$(D)_$(params1_Kitaev).pdf",fig)
