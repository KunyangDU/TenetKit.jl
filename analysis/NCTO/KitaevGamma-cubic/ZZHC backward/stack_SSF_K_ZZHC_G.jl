...
lsHf = 0:0.02:0.8
lsk = map(x -> coordinate(x/4;basis = KBASIS2),[[0.45,0.18],])
...
save("$(figurename)/stack_SSF_$(Lx)x$(Ly)_$(D)_$(θ/pi)_$(ϕ/pi)_$(K)_K.png",fig)
save("$(figurename)/stack_SSF_$(Lx)x$(Ly)_$(D)_$(θ/pi)_$(ϕ/pi)_$(K)_K.pdf",fig)
# end
