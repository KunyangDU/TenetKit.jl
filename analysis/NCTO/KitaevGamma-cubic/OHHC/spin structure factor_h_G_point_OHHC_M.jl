...
Colorbar(fig[1,2],hmt;label = L"\tilde{S}(M)")


resize_to_layout!(fig)
display(fig)

save("$(figurename)/structure factor_h_G_point_M_$(L)_$(D)_$(θ/pi)_$(ϕ/pi).png",fig)
save("$(figurename)/structure factor_h_G_point_M_$(L)_$(D)_$(θ/pi)_$(ϕ/pi).pdf",fig)
