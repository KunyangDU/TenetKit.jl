...
save("$(figurename)/structure factor_h_G_point_UUD_$(L)_$(D)_$(params_Kitaev).png",fig)
save("$(figurename)/structure factor_h_G_point_UUD_$(L)_$(D)_$(params_Kitaev).pdf",fig)
