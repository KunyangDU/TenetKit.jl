...
figsize = (width = 24*2/3*(Ly)*3/4,height = 24*2/3*(Ly)*sqrt(3)/2)
figsizet = (width = 40*(Ly)*3/4,height = 40*(Ly)*sqrt(3)/2)
...
for ax in [axt,axxy,axzz]
    ...
    boundary!(ax,MFBZpoint;linewidth = 7*ax.height.val/250,breathing=1.027)
