...
save("J1J2chain/figures/rescale/DOP_$(Lx)x$(Ly)_D=$(D)_$(tailname).pdf",fig)
save("J1J2chain/figures/rescale/DOP_$(Lx)x$(Ly)_D=$(D)_$(tailname).png",fig)

@save "J1J2chain/data/rescale/DOP_$(Lx)x$(Ly)_D=$(D)_$(tailname).jld2" nndop
