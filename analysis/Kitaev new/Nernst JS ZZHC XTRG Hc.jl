...
display(fig)
save("Kitaev new/figures/Nernst_single_JS_XTRG_Hc_$(Lx)x$(Ly)_$(D)_$(K)_$(proj).pdf",fig)
save("Kitaev new/figures/Nernst_single_JS_XTRG_Hc_$(Lx)x$(Ly)_$(D)_$(K)_$(proj).png",fig)
