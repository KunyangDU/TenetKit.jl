...
dataname = "../codes/examples/Kitaev/data1/ZZHC/test"
...
for k in 1:3,(j,l) in bonds[k]
    ...
    c = log10(abs(JS[j,l]))
    arrow0!(ax,x,y,u,v;arrowsize = 0.5,linewidth = 2,color = get(colorschemes[:Greens],c,(-5,-3)))
end

Colorbar(fig[1,2],colormap = colorschemes[:Greens],colorrange= (-5,-3),
label = L"\log_{10} \ J_S")
