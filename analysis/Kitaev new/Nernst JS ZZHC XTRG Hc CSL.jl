...
display(fig)
save("Kitaev new/figures/Nernst_single_JS_XTRG_Hc_CSL_$(Lx)x$(Ly)_$(D)_$(params)_$(proj).pdf",fig)
save("Kitaev new/figures/Nernst_single_JS_XTRG_Hc_CSL_$(Lx)x$(Ly)_$(D)_$(params)_$(proj).png",fig)
